...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        result = findViewById(R.id.resultadoHelado);
        ...
        result.setText(android.text.Html.fromHtml(representacionCompleta, android.text.Html.FROM_HTML_MODE_LEGACY));

        fin.setOnClickListener(v -> finish());
